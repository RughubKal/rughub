...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center bg-hero-bg text-hero-foreground overflow-hidden pt-20">
      {/* Background Image */}
        ...
        <div className="container mx-auto container-padding py-[20px]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-3xl p-8 bg-hero-foreground/10 backdrop-blur-sm rounded-xl border border-hero-foreground/20 max-w-md mx-auto hover:bg-hero-foreground/15 transition-all duration-300">
              ...
              <p className="text-3xl font-bold mb-1">$27.50 incl GST<span className="text-lg font-normal"> per sqm</span></p>
